...
$l['mybb_incorrect_folder'] = "<div class=\"border_wrapper upgrade_note\" style=\"padding: 4px;\">
	...
	<p>Auch wenn kein Fehler vorliegt wird empfohlen, dass die Dateien aus dem Ordner \"Upload\" auf den Server übertragen werden und nicht der Ordner selbst.<br /><br />Für mehr Informationen siehe auch <a href=\"http://www.mybboard.de/doku/installationaktualisierung/installation.html\" target=\"_blank\">Installation</a>.</p>
</div>";
...
$l['req_step_error_cachedir'] = 'Der Ordner für den Zwischenspeicher (cache/) ist nicht beschreibbar. Bitte korrigieren Sie die Berechtigungen (<a href="http://www.mybboard.de/doku/installationaktualisierung/installation.html" target="_blank">Dateirechte</a>), so dass der Ordner beschrieben werden kann.';
$l['req_step_error_uploaddir'] = 'Der Ordner für Uploads (uploads/) ist nicht beschreibbar. Bitte korrigieren Sie die Berechtigungen (<a href="http://www.mybboard.de/doku/installationaktualisierung/installation.html" target="_blank">Dateirechte</a>), so dass der Ordner beschrieben werden kann.';
$l['req_step_error_avatardir'] = 'Der Ordner für Avatare (uploads/avatars/) ist nicht beschreibbar. Bitte korrigieren Sie die Berechtigungen (<a href="http://www.mybboard.de/doku/installationaktualisierung/installation.html" target="_blank">Dateirechte</a>), so dass der Ordner beschrieben werden kann.';
$l['req_step_error_cssddir'] = 'Der Ordner für CSS (css/) ist nicht beschreibbar. Bitte korrigieren Sie die Berechtigungen (<a href="http://www.mybboard.de/doku/installationaktualisierung/installation.html" target="_blank">Dateirechte </a>), so dass der Ordner beschrieben werden kann.';
