...
$l['enter_password_below'] = "Bitte geben Sie das Passwort ein:";
$l['verify_forum_password'] = "Passwort bestätigen";
$l['wrong_forum_password'] = "Das eingegebene Passwort ist falsch. Bitte versuchen Sie es erneut.";
...
$l['attachments_desc'] = "Sie können ein oder mehrere Anhänge zu diesem Beitrag hinzufügen. Wählen Sie die Datei auf der rechten Seite und klicken Sie auf 'Anhang hinzufügen', um die Datei hochzuladen.";
...
$l['attachment_too_big_upload'] = "Sie können maximal {1} Byte auf einmal hochladen.";
...
$l['thread_subscription_method_desc'] = "Geben Sie die Art der E-Mail-Benachrichtigung und des Abonnements für dieses Thema an (nur registrierte Benutzer).";
...
$l['editor_cutnosupport'] = "Ihr Browser unterstützt den Befehl Ausschneiden nicht. Bitte verwenden Sie die Tastenkombination Strg-X.";
$l['editor_copynosupport'] = "Ihr Browser unterstützt den Befehl Kopieren nicht. Bitte verwenden Sie die Tastenkombination Strg-C.";
$l['editor_pastenosupport'] = "Ihr Browser unterstützt den Befehl Einfügen nicht. Bitte verwenden Sie die Tastenkombination Strg-V.";
$l['editor_pasteentertext'] = "Fügen Sie den Text in das folgende Eingabefeld ein:";
...
$l['postbit_unapproved_attachment'] = "1 nicht moderiertes Anhang";
...
$l['postbit_reputation_add'] = "Geben Sie diesem Benutzer eine Bewertung";
...
$l['postbit_currently_ignoring_user'] = "Der Inhalt dieses Beitrags wird nicht angezeigt, weil {1} auf Ihrer <a href=\"usercp.php?action=editlists\">Ignorierliste</a> steht.";
$l['postbit_post_under_moderation'] = "Der von Ihnen erstellte Beitrag wartet auf Freischaltung und ist nicht öffentlich einsehbar. Sobald ein Moderator ihn freischaltet, wird er für alle sichtbar.";
...
$l['redirect'] = "Sie werden jetzt weitergeleitet";
...
$l['on'] = "aktiviert";
$l['off'] = "deaktiviert";
$l['remote_avatar_disabled_default_avatar'] = "Sie verwenden derzeit ein externes Avatar, das gesperrt wurde. Daher wird stattdessen das Standard-Avatar angezeigt.";
...
$l['attach_quota'] = "Es stehen Ihnen {1} zum Speichern von Anhänge zur Verfügung.";
...
$l['quickrestore_confirm'] = "Möchten Sie diesen Beitrag wirklich wiederherstellen?";
...
$l['error_loadlimit'] = "Das maximale Server-Load-Limit ist erreicht. Bitte versuchen Sie es später nochmal, wenn der Server nicht mehr so ausgelastet ist.";
$l['error_boardclosed'] = "Dieses Forum ist zur Zeit geschlossen. Der Administrator hat folgenden Grund angegeben:";
$l['error_banned'] = "Entschuldigung, aber Sie sind aus dem Forum ausgeschlossen. Es kann sein, dass Sie keine Beiträge schreiben, Themen lesen oder das Forum betreten können. Bei weiteren Fragen kontaktieren Sie bitte den Forenadministrator.";
$l['error_cannot_upload_php_post'] = "Die Datei konnte nicht hochgeladen werden - Zu groß für die PHP-Einstellung post_max_size. Bitte klicken Sie auf den Zurück-Button.";
...
$l['invalid_hcaptcha'] = "Bitte lösen Sie hCaptcha um zu verifizieren, dass Sie kein Bot sind.";
...
$l['verification_note_hcaptcha'] = "Bitte klicken Sie auf das Kontrollkästchen, das Sie unten sehen. Dies ist nötig, um automatisierte Spambots zu stoppen.";
$l['verification_subnote'] = "(Keine Beachtung von Groß- und Kleinschreibung)";
$l['invalid_nocaptcha_transmit'] = "Es ist ein Fehler bei der Verifizierung von reCAPTCHA aufgetreten. Bitte versuchen Sie es erneut.";
$l['invalid_hcaptcha_transmit'] = "Es ist ein Fehler bei der Verifizierung von hCaptcha aufgetreten. Bitte versuchen Sie es erneut.";
...
$l['error_emailflooding_1_second'] = "Entschuldigung, Sie können nur alle {1} Minuten eine E-Mail versenden. Bitte warten Sie eine Sekunde vor dem erneuten Versenden der E-Mail.";
$l['error_emailflooding_seconds'] = "Entschuldigung, Sie können nur alle {1} Minuten eine E-Mail versenden. Bitte warten Sie {2} Sekunden vor dem erneuten Versenden der E-Mail.";
$l['error_emailflooding_1_minute'] = "Entschuldigung, Sie können nur alle {1} Minuten eine E-Mail versenden. Bitte warten Sie eine Minute vor dem erneuten Versenden der E-Mail.";
$l['error_emailflooding_minutes'] = "Entschuldigung, Sie können nur alle {1} Minuten eine E-Mail versenden. Bitte warten Sie {2} Minuten vor dem erneuten Versenden der E-Mail.";
$l['error_invalidfromemail'] = "Sie haben keine gültige E-Mail-Adresse eingegeben.";
$l['error_noname'] = "Sie haben keinen gültigen Namen eingegeben.";
$l['your_email'] = "Ihre E-Mail-Adresse:";
$l['email_note'] = "Geben Sie hier Ihre E-Mail-Adresse ein.";
$l['your_name'] = "Ihr Name:";
$l['name_note'] = "Geben Sie hier Ihren Namen ein.";
...
$l['moderation_forum_attachments'] = "Bitte beachten Sie, dass neue Anhänge in diesem Forum von einem Moderator freigeschaltet werden müssen, bevor sie sichtbar werden.";
