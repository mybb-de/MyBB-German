...
$l['public_note'] = "<b>Hinweis:</b> Dies ist eine öffentliche Umfrage. Andere Benutzer können sehen, was Sie gewählt haben.";
$l['total'] = "Gesamt";
$l['vote'] = "Abstimmen";
$l['total_votes'] = "{1} Stimme(n)";
$l['you_voted'] = "&lowast; Sie haben diese Antwort gewählt.";
...
$l['inline_no_post_selected'] = "Sie müssen einen oder mehrere Beiträge auswählen, für die Sie die Moderationsaktion durchführen möchten.";
$l['inline_go'] = "Los";
$l['clear'] = "Löschen";
$l['thread_closed'] = "Thema geschlossen";
$l['no_subject'] = "Kein Betreff";

$l['error_nonextnewest'] = "Es gibt keine Themen, die neuer sind, als das, welches Sie sich als letztes angesehen haben.";
$l['error_nonextoldest'] = "Es gibt keine Themen, die älter sind, als das, welches Sie sich als letztes angesehen haben.";
$l['quickreply_multiquote_selected'] = "Sie haben einen oder mehrere Beiträge zum Zitieren ausgewählt.";
$l['quickreply_multiquote_now'] = "Zitieren Sie diese Beiträge jetzt";
$l['or'] = "oder";
$l['quickreply_multiquote_deselect'] = "wählen Sie sie ab";
