...
$l['find_attachments_desc'] = "Über die Suche können Sie bestimmte Anhänge finden, die im Forum an Beiträge angefügt wurden. Benutzen Sie dazu das folgende Formular. Alle Felder sind optional und werden nur in die Suche einbezogen, wenn sie ausgefüllt wurden.";
$l['find_orphans'] = "Suche verwaiste Anhänge";
$l['find_orphans_desc'] = "Verwaiste Anhänge sind Dateien, die aus irgendeinem Grund auf dem Server oder in der Datenbank fehlen. Über dieses Werkzeug können Sie solche Anhänge finden und entfernen.";
$l['attachment_stats'] = "Anhang-Statistiken";
$l['attachment_stats_desc'] = "Hier finden Sie allgemeine Angaben zu den Anhänge in Ihrem Forum.";

// Errors
$l['error_nothing_selected'] = "Sie haben keine Anhänge zum Entfernen ausgewählt.";
$l['error_no_attachments'] = "In Ihrem Forum gibt es keine Anhänge. Dieser Bereich ist erst verfügbar, nachdem ein Anhang an einen Beitrag angefügt wurde.";
...
$l['success_no_orphans'] = "In Ihrem Forum gibt es keine verwaisten Anhänge.";
