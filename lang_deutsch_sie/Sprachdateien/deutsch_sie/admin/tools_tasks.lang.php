...
$l['confirm_task_enable'] = "<strong>WARNUNG:</strong> Sie sind gerade dabei, eine Aufgabe zu aktivieren, die nur von einem Cron-Job ausgeführt werden sollte (Bitte schauen Sie in die <a href=\"https://docs.mybb.com/1.8/administration/task-manager/\" target=\"_blank\">MyBB Doku</a> für weitere Informationen). Fortsetzen?";
