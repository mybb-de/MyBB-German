...
$l['thread_tools_desc'] = "Eigene Moderationstools erlauben es Ihnen, bestimmte Aktionen auf Themen und Beiträge anzuwenden. Diese können dann wie die Standardtools im Forum verwendet werden. Hier können Sie Ihre eigenen Thementools verwalten.";

$l['add_thread_tool'] = "Thementool hinzufügen";
$l['add_new_thread_tool'] = "Neues Thementool hinzufügen";
$l['add_thread_tool_desc'] = "Hier können Sie ein neues Thementool erstellen. Dieses Tool wird im Forum in der Inlinemoderation neben allen anderen Tools zur Verfügung gestellt.";

$l['post_tools'] = "Beitragstools";
$l['post_tools_desc'] = "Eigene Beitragstools erlauben es Ihnen, bestimmte Aktionen auf Themen und Beiträge anzuwenden. Diese können dann wie die Standardtools im Forum verwendet werden. Hier können Sie Ihre eigenen Beitragstools verwalten.";
...
$l['merge_posts'] = "Beiträge dauerhaft zusammenfügen?";
...
$l['private_message_message_desc'] = "Nachricht, die an den Ersteller des Themas gesendet wird. Lassen Sie das Feld leer um diese Funktion zu deaktivieren.";
$l['private_message_subject'] = "Betreff";
$l['private_message_subject_desc'] = "Geben Sie den Betreff der Privaten Nachricht ein.";

$l['error_missing_title'] = "Bitte geben Sie einen Namen für dieses Tool an.";
