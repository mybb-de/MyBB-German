...
$l['add_forum_desc'] = "Hier können Sie ein Forum oder eine Kategorie erstellen. Zudem können Sie die Grundberechtigungen setzen.";
$l['copy_forum'] = "Forum kopieren";
$l['copy_forum_desc'] = "Hier können Sie die Einstellungen und Berechtigungen eines Forums auf ein anderes oder ein neues Forum kopieren.";
$l['forum_permissions'] = "Berechtigungen";
$l['forum_permissions_desc'] = "Hier haben Sie die volle Kontrolle über alle Berechtigungen.";
$l['view_forum'] = "Forum ansehen";
$l['view_forum_desc'] = "Hier können Sie die Unterforen einsehen, Berechtigungen setzen und Moderatoren zuweisen.";
$l['add_child_forum'] = "Unterforum hinzufügen";
$l['edit_forum_settings'] = "Foreneinstellungen bearbeiten";
$l['edit_forum_settings_desc'] = "Hier können Sie die Einstellungen und Berechtigungen eines existierenden Forums ändern.";
$l['edit_forum'] = "Forum bearbeiten";
$l['edit_mod'] = "Moderator bearbeiten";
$l['edit_mod_desc'] = "Hier können Sie die Einstellungen für einen bestimmten Moderator ändern.";
...
$l['error_forum_parent_child'] = "Sie können als übergeordnetes Forum nicht ein Unterforum des Forums selbst wählen.";
$l['error_forum_parent_itself'] = "Das übergeordnete Forum kann nicht das Forum selbst sein.";
$l['error_incorrect_moderator'] = "Bitte geben Sie einen gültigen Moderator an.";
...
$l['forum_link_desc'] = "Soll dieses Forum auf eine andere Seite weiterleiten, geben Sie bitte hier die URL an. Die Angabe einer URL deaktiviert die Funktionalität des Forums. Trotzdem können Berechtigungen gesetzt werden.";
$l['forum_password'] = "Forenpasswort";
$l['forum_password_desc'] = "Um das Forum vor Zugriffen zu schützen, können Sie ein Passwort für den Zugang angeben. Hinweis: Benutzergruppen brauchen trotzdem die nötigen Rechte, um das Forum betreten zu können.";
...
$l['error_no_parent'] = "Sie müssen ein übergeordnetes Forum wählen.";
...
$l['error_new_forum_needs_name'] = "Sie müssen dem neuen Forum einen Namen geben.";
