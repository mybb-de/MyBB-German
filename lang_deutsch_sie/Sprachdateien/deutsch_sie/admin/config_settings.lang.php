...
$l['setting_contact_purgespammerpostlimit_desc'] = "Diese Einstellung erlaubt Ihnen einzustellen, ab welcher Beitragsanzahl ein Benutzer nicht gelöscht werden kann. Damit soll verhindert werden, dass aktive Benutzer gelöscht werden. Wählen Sie 0 um die Beitragsanzahl nicht zu prüfen; dies wird allerdings nicht empfohlen.";
...
$l['setting_contact_purgespammerbangroup_desc'] = "Geben Sie die ID der Gruppe (nicht den Namen) ein, in die gesperrte Benutzer verschoben werden. Standard ist 7, die Standard-Gruppe des MyBBs.  In der oberen Einstellung muss \"Dauerhaft sperren\" ausgewählt sein.";
$l['setting_contact_purgespammerapikey'] = "Stop Forum Spam API Key";
$l['setting_contact_purgespammerapikey_desc'] = "Um die Daten von Spammern an Stop Forum Spam übermitteln zu können, benötigen Sie einen API-Key. Um einen zu erhalten, melden Sie sich <a href=\"http://stopforumspam.com/signup\" target=\"_blank\">hier</a> an. Nach Erhalt des Keys, tragen Sie diesen hier ein.";
?>