...
$l['mybb_admin_panel'] = "MyBB Administrations-Panel";
$l['mybb_admin_cp'] = "MyBB Admin-CP";
$l['logged_in_as'] = "Angemeldet als";
$l['view_board'] = "Forum ansehen";
$l['logout'] = "Abmelden";

// Footer language strings
$l['generated_in'] = "Generiert in {1} mit <a href=\"{2}\" target=\"_blank\">{3} Datenbankabfragen</a>. Speicherbenutzung: {4}";

// Login page
$l['enter_username_and_password'] = "Bitte geben Sie {1} und Ihr Passwort ein.";
$l['login_username'] = "Ihren Benutzernamen";
$l['login_email'] = "Ihre E-Mail-Adresse";
$l['login_username_and_password'] = "Ihren Benutzernamen oder Ihre E-Mail-Adresse";
...
// Access Denied
$l['access_denied'] = "Zugriff nicht gestattet";
$l['access_denied_desc'] = "Ihnen fehlt die Berechtigung, diesen Teil des Admin-CPs zu betreten.";

// Super Administrator required
$l['cannot_perform_action_super_admin_general'] = "Entschuldigung, aber Sie können diese Aktion nicht durchführen, da Sie kein Super-Administrator sind.<br /><br />Um diese Aktion durchzuführen, müssen Sie Ihre Benutzer-ID in der Datei \"inc/config.php\" hinterlegen.";
...
$l['confirm_delete_logs'] = "Ausgewählte Logeinträge entfernen?";
$l['confirm_delete_all_logs'] = "Alle Logeinträge entfernen?";
$l['selected_logs_deleted'] = "Die ausgewählten Logeinträge wurden entfernt.";
$l['all_logs_deleted'] = "Alle Logeinträge wurden entfernt.";
$l['delete_selected'] = "Ausgewählte entfernen";
$l['delete_all'] = "Alle entfernen";

// Misc
$l['encountered_errors'] = "Folgende Fehler sind aufgetreten:";
$l['invalid_post_verify_key'] = "Der Autorisierungscode konnte nicht bestätigt werden. Bitte bestätigen Sie, dass Sie diese Aktion ausführen möchten.";
$l['invalid_post_verify_key2'] = "Der Autorisierungscode konnte nicht bestätigt werden. Bitte stellen Sie sicher, dass Sie diese Seite korrekt aufrufen.";
...
$l['enter_username_and_token'] = "Bitte geben Sie Ihren Benutzernamen und den Aktivierungscode ein um fortzufahren.";
...
$l['locked_out_subject'] = "Ihr Benutzerkonto bei {1} wurde ausgeschlossen";
$l['locked_out_message'] = "{1},

Ihr Benutzerkonto bei {2} wurde nach {3} fehlerhaften Anmelde-Versuchen gesperrt.

Um Ihr Benutzerkonto wieder freizuschalten, öffnen Sie bitte folgenden Link in Ihrem Browser.
