...
$l['open_thread'] = "Thema öffnen";
$l['close_thread'] = "Thema schließen";
$l['stick_thread'] = "Thema wichtig";
$l['unstick_thread'] = "Thema unwichtig";
$l['author'] = "Verfasser";
$l['message'] = "Nachricht";
...
$l['select_a_tool'] = "Wähle ein Tool";
...
$l['poll'] = "Umfrage:";
$l['show_results'] = "Zeige Ergebnisse";
$l['edit_poll'] = "Umfrage bearbeiten";
$l['public_note'] = "<b>Hinweis:</b> Dies ist eine öffentliche Umfrage. Andere Benutzer können sehen, was du gewählt hast.";
$l['total'] = "Gesamt";
$l['vote'] = "Abstimmen";
...
$l['no_voting_permission'] = "Du hast keine Berechtigung bei dieser Umfrage abzustimmen.";
$l['undo_vote'] = "Stimme zurückziehen";
$l['quick_reply'] = "Schnellantwort";
$l['message_note'] = "Gib hier deine Antwort zum Beitrag ein.";
$l['signature'] = "Signatur";
$l['email_notify'] = "E-Mail-Benachrichtigung";
...
$l['similar_threads'] = "Möglicherweise verwandte Themen&hellip;";
$l['thread'] = "Thema";
$l['replies'] = "Antworten";
$l['views'] = "Ansichten";
...
$l['users_browsing_thread_reading'] = "Lesen&hellip;";
...
$l['inline_no_tool_selected'] = "Bitte wähle ein Tool aus, um eine Moderationsaktion durchzuführen.";
$l['inline_no_post_selected'] = "Du musst einen oder mehrere Beiträge auswählen, für die du die Moderationsaktion durchführen möchten.";
$l['inline_go'] = "Los";
$l['clear'] = "Löschen";
$l['thread_closed'] = "Thema geschlossen";
$l['no_subject'] = "Kein Betreff";

$l['error_nonextnewest'] = "Es gibt keine Themen, die neuer sind, als das, welches du dir als letztes angesehen hast.";
$l['error_nonextoldest'] = "Es gibt keine Themen, die älter sind, als das, welches du dir als letztes angesehen hast.";
$l['quickreply_multiquote_selected'] = "Du hast einen oder mehrere Beiträge zum Zitieren ausgewählt.";
$l['quickreply_multiquote_now'] = "Zitiere diese Beiträge jetzt";
$l['or'] = "oder";
$l['quickreply_multiquote_deselect'] = "wähle sie ab";
$l['search_thread'] = "Thema durchsuchen";
...
$l['post_deleted_error'] = 'Du kannst diese Aktion nicht auf einen gelöschten Beitrag anwenden.';