...
$l['pms_new'] = "Du hast <strong>{1}</strong> neue Nachricht(en) seit deinem letzten Besuch.";
$l['pms_unread_total'] = "(ungelesene Nachricht(en): <strong>{1}</strong>, Nachricht(en) insgesamt: <strong>{2}</strong>)";
...
$l['stats_newestuser'] = "Unser neuestes Mitglied heißt: <strong>{1}</strong>";
$l['stats_mostonline'] = "Besucherrekord: {1} ({2} um {3} Uhr)";
