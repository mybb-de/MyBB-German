...
$l['postdata_missing_subject'] = 'Der Betreff fehlt. Bitte gib einen Betreff ein.';
$l['postdata_missing_message'] = 'Die Nachricht fehlt. Bitte gib eine Nachricht ein.';
$l['postdata_message_too_long'] = 'Die Nachricht ist zu lang. Bitte gib eine Nachricht kürzer als {1} Zeichen ein (zur Zeit {2})..';
$l['postdata_message_too_short'] = 'Die Nachricht ist zu kurz. Bitte gib eine Nachricht länger als {1} Zeichen ein.';
$l['postdata_subject_too_long'] = 'Der Betreff ist zu lang. Bitte gib einen Betreff kürzer als 85 Zeichen ein (zur Zeit {1}).';
