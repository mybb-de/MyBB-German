...
$l['attachment_types_desc'] = "Hier kannst du neue Attachment-Typen erstellen oder bestehende bearbeiten. Attachment-Typen geben vor, welchen Dateityp Benutzer an Beiträge in deinem Forum anhängen dürfen. Hinweis: Das Deaktivieren eines Attachment-Typs macht bestehende Anhänge dieses Typs unzugänglich.";
...
$l['name'] = "Name";
$l['name_desc'] = "Gib den Name des Attachment-Typs ein.";
...
$l['mime_type_desc'] = "Gib den MIME-Typ an, der vom Server beim Herunterladen einer Datei gesendet wird (<a href=\"https://wiki.selfhtml.org/wiki/Referenz:MIME-Typen\" target=\"_blank\">Weitere Informationen</a>)";
