...
$l['setting_group_onlineoffline_desc'] = "Hier kannst du dein Forum komplett ein- oder ausschalten und einen Grund für den Offline-Modus angeben.";
...
$l['setting_homename_desc'] = "Der Name deiner Homepage. In der Fußzeile auf jeder Seite des Forums, wird ein Link zu dieser Seite angezeigt.";
...
$l['setting_contactlink_desc'] = "In der Fußzeile auf jeder Seite, wird der Kontakt-Link angezeigt. Dafür kannst du eine E-Mail-Adresse (mailto:email@domain.tld) oder einen Hyperlink (http://www.domain.tld/kontakt.php) angeben.";
...
$l['setting_decpoint_desc'] = "Der Dezimalpunkt, der in deiner Region verwendet wird (Empfohlene Einstellung für Deutschland: \",\").";
...
$l['setting_enablepms_desc'] = "Wähle \"Nein\", wenn das private Nachrichtensystem in deinem Forum ausgeschaltet werden soll.";
...
$l['setting_gzipoutput_desc'] = "Willst Du, dass die Seiten im GZip-Format komprimiert werden, bevor sie an den Browser geschickt werden? Effekt: Schnellerer Seitenaufbau und weniger Traffic. Die Stärke der Kompression wird abhängig von der Serverlast bestimmt.";
...
$l['setting_mail_logging_desc'] = "Hier kannst du einstellen, wie E-Mails über die über die \"Thema einem Freund senden\" Funktion geloggt werden sollen. In einigen Ländern ist es nicht erlaubt, den Inhalt zu loggen.";
$l['setting_pmfloodsecs'] = "Zeit zwischen PN-Versand";
$l['setting_pmfloodsecs_desc'] = "Gib die Zeit an (in Sekunden), die ein Benutzer zwischen dem Versand einzelner privater Nachrichten warten muss (0 = deaktiviert).";
