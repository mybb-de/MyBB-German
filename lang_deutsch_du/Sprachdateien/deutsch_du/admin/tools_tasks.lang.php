...
$l['confirm_task_enable'] = "<strong>WARNUNG:</strong> Du bist gerade dabei, eine Aufgabe zu aktivieren, die nur von einem Cron-Job ausgeführt werden sollte (Bitte schaue in die <a href=\"http://www.mybboard.de/doku/\" target=\"_blank\">MyBB Doku</a> für weitere Informationen). Fortsetzen?";
