...
$l['website_url'] = "Deine Hompageadresse:";
...
$l['email_notify'] = "Automatisch Themen abonnieren, zu denen du geschrieben hast.";
...
$l['time_offset_desc'] = "Wenn du in einer Zeitzone lebst, die sich von der des Forums unterscheidet, kannst du diese aus der Liste auswählen.";
...
$l['redirect_registered_coppa_activate'] = "Vielen Dank für deine Registrierung bei {1}, {2}. Dein Konto wurde erfolgreich erstellt. Wenn der Besitzer dieses Kontos jünger als 13 Jahre ist, muss zuerst eine elterliche Genehmigung eingeholt werden.<br /><br />Ein Elternteil oder gesetzlicher Verteter muss unser <a href=\"member.php?action=coppa_form\">COPPA Zustimmungs- &amp; Erlaubnisformular</a> herunterladen, ausfüllen und uns eine vollständige Kopie schicken.<br /><br />Sobald wir eine vollständige Kopie erhalten haben, wird das Konto aktiviert.";
$l['coppa_compliance'] = "COPPA Zustimmung";
$l['coppa_desc'] = "Um dich in diesem Forum zu registrieren, musst du dein Alter mit <a href=\"http://coppa.org\" title=\"Children's Online Privacy Protection Act\" target=\"_blank\" rel=\"noopener\">COPPA</a> verifizieren. Bitte gib unten dein Geburtsdatum ein.<br /><br />Wenn du jünger als 13 Jahre bist, musst du zuvor die Zustimmung der Eltern einholen. Ein Elternteil oder gesetzlicher Verteter muss unser <a href=\"member.php?action=coppa_form\">COPPA Zustimmungs- &amp; Erlaubnisformular</a> herunterladen, ausfüllen und uns eine vollständige Kopie schicken.";
$l['coppa_desc_for_deny'] = "Um dich in diesem Forum zu registrieren, musst du dein Alter mit <a href=\"http://coppa.org\" title=\"Children's Online Privacy Protection Act\" target=\"_blank\" rel=\"noopener\">COPPA</a> verifizieren. Bitte gib unten dein Geburtsdatum ein.";
$l['hide_dob'] = "Du kannst dein Geburtsdatum nach der Registrierung verstecken, indem du dein Profil änderst.";
...
$l['referrer_desc'] = "Wurde dir das Forum von einem unserer Benutzer empfohlen, gib hier seinen Namen ein.";
...
$l['redirect_accountactivated'] = "Dein Konto wurde erfolgreich aktiviert.<br />Du wirst jetzt zur Startseite weitergeleitet.";
$l['redirect_accountactivated_admin'] = "Deine E-Mail-Adresse wurde erfolgreich überprüft.<br />Dein Konto muss nun durch einen Administrator freigegeben werden. Bis dahin kann es sein, dass du in diesem Forum keine Beiträge schreiben kannst.<br />Du wirst jetzt zur Startseite weitergeleitet.";
$l['redirect_registered'] = "Vielen Dank für Deine Registrierung bei {1}, {2}.<br />Du wirst jetzt zur Startseite weitergeleitet.";
$l['redirect_registered_admin_activate'] = "Vielen Dank für deine Registrierung bei {1}, {2}.<br />Dein Konto muss durch einen Administrator freigegeben werden. Bis dahin kann es sein, dass du in diesem Forum keine Beiträge schreiben kannst.";
$l['redirect_loggedout'] = "Du hast dich erfolgreich ausgeloggt. Du wirst jetzt zur Startseite weitergeleitet.";
$l['redirect_alreadyloggedout'] = "Du hast dich entweder schon abgemeldet oder noch nicht angemeldet.<br />Du wirst jetzt zur Startseite weitergeleitet.";
$l['redirect_lostpwsent'] = "Vielen Dank! An alle Konten, die unter dieser E-Mail-Adresse laufen, wurde eine Nachricht mit weiteren Anweisungen versandt.<br /><br />Du wirst jetzt zur Startseite weitergeleitet.";
$l['redirect_activationresent'] = "Deine Aktivierungs-Mail wurde erneut versandt.";
$l['redirect_passwordreset'] = "Vielen Dank! Das Passwort für deinen Konto wurde zurückgesetzt. Das neue, zufallsgenerierte Passwort wurde an deine E-Mail-Adresse versandt.";
...
$l['redirect_validated'] = "Vielen Dank und herzlich willkommen! Dein Konto wurde freigeschaltet.<br />Du wirst jetzt zu den Foren weitergeleitet.";
...
$l['error_alreadyregistered'] = "Entschuldigung, aber Du hast dich schon in diesem Forum registriert und die Registrierung von mehreren Konten wurde unterbunden.";
...
$l['error_badlostpwcode'] = "Du hast einen ungültigen Code eingegeben, um dein Passwort zurückzusetzen. Bitte kontrolliere deine Eingabe oder wende dich an einen Administrator für Hilfe.";
$l['error_badactivationcode'] = "Du hast einen ungültigen Aktivierungscode eingegeben. <a href=\"member.php?action=resendactivation\">Klicke hier</a>, um die Aktivierungsmail erneut zu verschicken.";
$l['error_alreadyactivated'] = "Dein Konto ist bereits aktiviert oder benötigt keine Aktivierung per E-Mail.";
$l['error_alreadyvalidated'] = "Deine E-Mail-Adresse wurde bereits überprüft.";
$l['error_nothreadurl'] = "Deine Nachricht enthält nicht die URL des Themas. Bitte benutze die \"Thema einem Freund senden\"-Funktion.";
$l['error_bannedusername'] = "Du hast einen Benutzernamen eingegeben, der nicht registriert werden kann. Bitte wähle einen anderen Benutzernamen.";
...
$l['error_spam_deny'] = "Unser System hat erkannt, dass du ein Spammer sein könntest und deshalb die Registrierung verhindert. Wenn du dies für einen Fehler hältst, kontaktiere bitte den Administrator.";
$l['error_spam_deny_time'] = "Unser System hat erkannt, dass du ein Spammer sein könntest und deshalb die Registrierung verhindert. Registrierungen müssen mindestens {1} Sekunden dauern um automatisierte Anmeldungen zu verhindern, deine Registrierungen hat {2} Sekunden gedauert. Wenn du dies für einen Fehler hältst, kontaktiere bitte den Administrator.";
...
$l['js_validator_no_image_text'] = "Du musst den Text in obenstehendes Feld eingeben";
$l['js_validator_no_security_question'] = "Du musst die obenstehende Frage beantworten";
$l['js_validator_password_matches'] = "Du musst zwei Mal dieselben Passwörter eingeben";
$l['js_validator_password_complexity'] = "Komplexität des Passworts prüfen";
$l['js_validator_password_length'] = "Dein Passwort muss {1} oder mehr Zeichen haben";
$l['js_validator_bad_password_security'] = "Das eingegebene Passwort ähnelt entweder mit deinem Benutzernamen oder deiner E-Mail-Adresse. Bitte gib ein besseres Passwort ein.";
$l['js_validator_not_empty'] = "Du musst etwas für dieses Feld auswählen";
