...
$l['req_step_error_xmlsupport'] = 'MyBB benötigt PHP mit der Unterstützung für die Verarbeitung von XML. Bitte gehe auf <a href="http://www.php.net/xml" target="_blank" rel=\"noopener\">PHP.net</a> für weitere Informationen.';
$l['req_step_error_configdefaultfile'] = 'Die Konfigurationsdatei (inc/config.default.php) konnte nicht umbenannt werden. Bitte benenne die <u>config.default.php</u> manuell um in <u>config.php</u>, damit sie beschrieben werden kann. Bei Problemen kontaktiere bitte den <a href="https://www.mybb.de/support/" targert="_blank" rel=\"noopener\">MyBB Support</a>.';
$l['req_step_error_configfile'] = 'Die Konfigurationsdatei (inc/config.php) ist nicht beschreibbar. Bitte korrigiere die Berechtigungen (<a href="https://www.mybb.de/doku/installationaktualisierung/installation/" target="_blank" rel=\"noopener\">Dateirechte</a>), so dass die Datei beschrieben werden kann.';
$l['req_step_error_settingsfile'] = 'Die Einstellungsdatei (inc/settings.php) ist nicht beschreibbar. Bitte korrigiere die Berechtigungen (<a href="https://www.mybb.de/doku/installationaktualisierung/installation/" target="_blank" rel=\"noopener\">Dateirechte</a>), so dass die Datei beschrieben werden kann.';
$l['req_step_error_cachedir'] = 'Der Ordner für den Zwischenspeicher (cache/) ist nicht beschreibbar. Bitte korrigiere  die Berechtigungen (<a href="https://www.mybb.de/doku/installationaktualisierung/installation/" target="_blank" rel=\"noopener\">Dateirechte</a>), so dass der Ordner beschrieben werden kann.';
$l['req_step_error_uploaddir'] = 'Der Ordner für Uploads (uploads/) ist nicht beschreibbar. Bitte korrigiere die Berechtigungen (<a href="https://www.mybb.de/doku/installationaktualisierung/installation/" target="_blank" rel=\"noopener\">Dateirechte</a>), so dass der Ordner beschrieben werden kann.';
$l['req_step_error_avatardir'] = 'Der Ordner für Avatare (uploads/avatars/) ist nicht beschreibbar. Bitte korrigiere die Berechtigungen (<a href="https://www.mybb.de/doku/installationaktualisierung/installation/" target="_blank" rel=\"noopener\">Dateirechte</a>), so dass der Ordner beschrieben werden kann.';
$l['req_step_error_cssddir'] = 'Der Ordner für CSS (css/) ist nicht beschreibbar. Bitte korrigiere die Berechtigungen (<a href="https://www.mybb.de/doku/installationaktualisierung/installation/" target="_blank" rel=\"noopener\">Dateirechte</a>), so dass der Ordner beschrieben werden kann.';
...
$l['db_step_error_utf8mb4_error'] = '\'4-Byte UTF-8 Unicode\' benötigt MySQL 5.5.3 oder höher. Bitte wähle eine Kodierung, die mit der eingesetzten MySQL-Version kompatibel ist.';
...
$l['admin_step_createadmin'] ='<p>Du musst erst einen Benutzerkonto erstellen, über den du deine Kopie des MyBB verwalten kannst. Bitte gib unten die erforderlichen Daten ein, um das Konto zu erstellen.</p>';
$l['admin_step_admintable'] = '<div class="border_wrapper">
		...
		<thead>
		<tr>
			<th colspan="2" class="first last">Kontodetails</th>
		</tr>
		</thead>
		<tr class="first">
...
$l['admin_step_error_nouser'] = 'Du hast keinen Benutzernamen für den Administrator-Konto angegeben.';
$l['admin_step_error_nopassword'] = 'Du hast kein Passwort für den Administrator-Konto angegeben.';
$l['admin_step_error_nomatch'] = 'Die eingegebenen Passwörter stimmen nicht überein.';
$l['admin_step_error_noemail'] = 'Du hast keine E-Mail-Adresse für den Administrator-Konto angegeben.';
...
$l['done_whats_next'] = '<div class="error"><p><strong>Von einer anderen Forensoftware wechseln?</strong></p><p>MyBB bietet ein Merge System zum einfachen Zusammenfügen mehrerer Foren für verschiedene beliebte Foren-Systeme an, das einen leichten Wechsel zum MyBB erlaubt. Falls du gerne zum MyBB wechseln möchtest, bist du auf dem richtigen Weg. Erfahre mehr über das <a target="_blank" href="https://www.mybb.de/doku/merge-system/" rel=\"noopener\">Merge System</a>.</p>';
...
$l['login'] = "Anmeldung";
$l['login_desc'] = "Bitte gib deinen Benutzername und dein Passwort ein um die Upgraderoutine zu starten. Du musst ein Administrator des Forums sein um das Upgrade zu durchführen zu können.";
...
$l['no_permision'] = "Du hast keine Berechtigung diesen Vorgang auszuführen. Du benötigst Administrations-Rechte um das Upgrade durchzuführen.<br /><br />Falls du dich abmelden möchtest, klicke <a href=\"upgrade.php?action=logout&amp;logoutkey={1}\">hier</a>. Danach kannst du dich mit einem Administrator-Konto anmelden.";
